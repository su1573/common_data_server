 ...
 */
public class IvstmanagerDO implements Serializable {
	private static final long serialVersionUID = 1L;
	
	//投资管理人编码
	private String ivstmngcode;
	//投资管理人名称
	private String ivstmngname;
	//投资管理人简称
	...
	//投资管理人编号
	private String ivstmanagerid;

	/**
	 * 设置：投资管理人编码
	 */
	public void setIvstmngcode(String ivstmngcode) {
		this.ivstmngcode = ivstmngcode;
	}
	/**
	 * 获取：投资管理人编码
	 */
	public String getIvstmngcode() {
		return ivstmngcode;
	}
	/**
	 * 设置：投资管理人名称
	 */
	public void setIvstmngname(String ivstmngname) {
		this.ivstmngname = ivstmngname;
	}
	/**
	 * 获取：投资管理人名称
	 */
	public String getIvstmngname() {
		return ivstmngname;
	}
	/**
	 * 设置：投资管理人简称
	 ...
	 * 设置：投资管理人编号
	 */
	public void setIvstmanagerid(String ivstmanagerid) {
		this.ivstmanagerid = ivstmanagerid;
	}
	/**
	 * 获取：投资管理人编号
	 */
	public String getIvstmanagerid() {
		return ivstmanagerid;
	}
}
