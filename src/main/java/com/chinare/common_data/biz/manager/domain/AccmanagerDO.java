 ...
 */
public class AccmanagerDO implements Serializable {
	private static final long serialVersionUID = 1L;
	
	//账户管理人编码
	private String accmngcode;
	//账户管理人名称
	private String accmngname;
	//账户管理人简称
	...
	//代理人编码
	private String accmngid;

	/**
	 * 设置：账户管理人编码
	 */
	public void setAccmngcode(String accmngcode) {
		this.accmngcode = accmngcode;
	}
	/**
	 * 获取：账户管理人编码
	 */
	public String getAccmngcode() {
		return accmngcode;
	}
	/**
	 * 设置：账户管理人名称
	 */
	public void setAccmngname(String accmngname) {
		this.accmngname = accmngname;
	}
	/**
	 * 获取：账户管理人名称
	 */
	public String getAccmngname() {
		return accmngname;
	}
	/**
	 * 设置：账户管理人简称
	 ...
	 * 设置：代理人编码
	 */
	public void setAccmngid(String accmngid) {
		this.accmngid = accmngid;
	}
	/**
	 * 获取：代理人编码
	 */
	public String getAccmngid() {
		return accmngid;
	}
}
