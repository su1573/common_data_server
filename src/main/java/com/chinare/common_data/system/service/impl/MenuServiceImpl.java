...
import com.chinare.common_data.system.dao.MenuDao;
import com.chinare.common_data.system.dao.RoleMenuDao;
...
public class MenuServiceImpl implements MenuService {
	...
	public Tree<MenuDO> getSysMenuTree(Long id) {
		...
		for (MenuDO sysMenuDO : menuDOs) {
			...
			tree.setText(sysMenuDO.getNameChn());
	...
	public Set<String> listPerms(Long userId) {
		...
		if("AUTH-CENTER".equals(authServer)) {
			...
			perms = authCenterService.getUserPermsOfAppl(params);
		}else {
			perms = userMapper.getUserPermsOfAppl(params);
		}
