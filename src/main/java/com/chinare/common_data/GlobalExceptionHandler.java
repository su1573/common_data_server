...
public class GlobalExceptionHandler {
    ...
    public Result auth(HttpServletResponse response, Exception e) throws Exception {
        log.error("error=>", e);
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public Result validate(HttpServletResponse response, MethodArgumentNotValidException e) throws Exception {
        log.error("error=>", e);
        final List<NutMap> errors = new ArrayList<NutMap>();
        final List<String> infos = Lang.list();
