package com.chinare.common_data.common.utils;


import com.chinare.common_data.common.config.Constant;
import com.chinare.common_data.common.domain.ColumnDO;
import com.chinare.common_data.common.domain.TableDO;
...
public class GenUtils {
    ...
    public static List<String> getTemplates() {
        ...
        //templates.add("templates/common/demo/Mapper.java.vm");
        ...
        //templates.add("templates/common/demo/menu.sql.vm");
        return templates;
    }
...
//		}
        ...
        if (template.contains("list.html.vm")) {
            ...
            //				+ "modules" + File.separator + "demo" + File.separator + className.toLowerCase() + ".html";
        }
        ...
        if (template.contains("list.js.vm")) {
            ...
            //		+ "modules" + File.separator + "demo" + File.separator + className.toLowerCase() + ".js";
        }
